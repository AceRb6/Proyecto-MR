...
class Directors(models.Model):
    director_name = models.TextField(unique=True, blank=True, null=True)
...
class Genres(models.Model):
    genre_name = models.TextField(unique=True, blank=True, null=True)
...
class Movies(models.Model):
    ...
    cast_field = models.TextField(db_column='cast_', blank=True, null=True)  # Field renamed because it ended with '_'.
